...
require (
	github.com/LubyRuffy/pageviewer v0.0.0-20250714070656-6d20ad30efa8
...
replace (
	github.com/LubyRuffy/pageviewer => ../pageviewer
	github.com/ysmood/fetchup => github.com/ysmood/fetchup v0.3.0
)
